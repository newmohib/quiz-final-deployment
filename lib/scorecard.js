...
//for history
 ...
 //  var questionIdArray=[];
 //  var subjectId='1';
	// for (i in currentQuestionParse.questions) {
	//   question=currentQuestionParse.questions[i].id;
	//   subjectId=currentQuestionParse.questions[i].subjectId;
 ...
 //     var currentDateToLocla = currentDate.toLocaleString();
	//  //localStorage.setItem("shortStore",JSON.stringify(questionStatus));
	...
	// 	 var questionStatus ={"date":currentDateToLocla,"subjectId":subjectId,"questionId":questionIdArray,"averageScore":averageScore ,"totalScore":totalScore,"totalTime":totalTime,"correct":totalCorrects,"incorrect":totalIncorrect,"unanswered":totalUnanswered};
	...
	//      //var oldSoluton=currentSolution.oldData.push(questionStatus);
	...
	// 							  "userId":"102",
	// 						      "oldData":[
	// 		       		          {"date":currentDateToLocla,"subjectId":subjectId,"questionId":questionIdArray,"averageScore":averageScore ,"totalScore":totalScore,"totalTime":totalTime,"correct":totalCorrects,"incorrect":totalIncorrect,"unanswered":totalUnanswered}
	// 		        		     ]
	// 				          };
	...
	// }else{
	// 	//console.log('oldSolution not found');
